...
import 'package:navixplore/models/post_model.dart';
import 'package:navixplore/models/comment_model.dart';
...
class _FeedWidgetState extends State<FeedWidget> with SingleTickerProviderStateMixin {
  ...
  void _navigateToUserProfile() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => UserProfileScreen(userId: widget.postData.userId, isMyProfile: false)),
    );
  }
                      ...
                      onPressed: () {
                        showModalBottomSheet(
                          ...
                          builder: (context) => DraggableScrollableSheet(
                            ...
                            maxChildSize: 0.95,
                            expand: false,
                            builder: (_, controller) => Comment('post', widget.postData.id, scrollController: controller),
                          ),
                        );
                      },
...
class Comment extends StatefulWidget {
  ...
  Comment(this.type, this.postId, {Key? key, required this.scrollController}) : super(key: key);

...
import 'package:navixplore/presentation/models/restaurant_model.dart';
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Cuisine: ${restaurant.cuisineType} 🍽️",
                        style: const TextStyle(fontSize: 16),
                      ),
                      Text("Average Meal Price: ₹${restaurant.averageMealPrice} 💰",
                        style: const TextStyle(fontSize: 16),
                      ),
                      ...
                      if(restaurant.membershipBenefits.isNotEmpty)
                        Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            ...restaurant.membershipBenefits.map((benefit) =>
                                Text("• $benefit",
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "₹${restaurant.averageMealPrice} for two",
                              style: const TextStyle(
                                fontSize: 14,
                                color: Colors.grey,
                              ),

...
import 'package:navixplore/features/transports/nm_metro/penalties_card.dart';
            ...
            child: ListView(
              children: [
                PenaltieCard(
                    ...
                    section: "59",
                    penalty:
                        "Rs. 500 fine and Forfeiture of fare paid / removal from carriage"),
                PenaltieCard(
                  title: "Spitting",
                  section: "59",
                  penalty:
                ...
                PenaltieCard(
                  title:
                      "Taking or causing to take offensive material on the Metro railway",
                  section: "60",
                  penalty: "Rs. 500 fine in addition to damages",
                ),
                PenaltieCard(
                  title:
                      "Taking or causing to take dangerous material on the Metro railway",
                  section: "61",
                ...
                PenaltieCard(
                  ...
                  section: "62",
                  penalty:
                      "Exclusion from the Metro premises and Rs. 1000 fine or imprisonment up to 6 months or both",
                ),
                PenaltieCard(
                ...
                PenaltieCard(
                  ...
                  section: "64",
                  penalty:
                      "Imprisonment up to 3 months or Fine up to Rs.250 or with both",
                ),
                PenaltieCard(
                  title: "Walking on metro track without lawful authority",
                  section: "64",
                  penalty:
                      "Imprisonment up to 6 months or Fine up to Rs.500 or with both",
                ),
                PenaltieCard(
                  title: "Obstructing running of train, etc.",
                  section: "67",
                  penalty:
                      "Rs. 5000 fine or imprisonment up to 4 years or both",
                ),
                PenaltieCard(
                  title:
                      "Obstructing Metro railway official in discharging his/her duties",
                  section: "68",
                  penalty: "Rs. 1000 fine or imprisonment up to 1 year or both",
                ),
                PenaltieCard(
                  title:
                      "Travelling without a proper pass or ticket or beyond authorized distance",
                  section: "69",
                ...
                PenaltieCard(
                  ...
                  section: "73",
                  penalty:
                      "Rs. 500 fine and in default of payment of fine, imprisonment up to 6 months",
                ),
                PenaltieCard(
                  title: "Maliciously wrecking a train or causing sabotage",
                  section: "74",
                  penalty:
                      "Imprisonment for life or rigorous imprisonment up to 10 years or punishable with death, as the case may be",
                ),
                PenaltieCard(
                  title: "Unauthorized sale of tickets",
                  section: "75",
                  penalty:
                      "Rs. 500 fine or imprisonment up to 3 months or both and forfeiture of such tickets",
                ),
                PenaltieCard(
                  title:
                      "Maliciously hurting or attempting to hurt other persons traveling by Metro railway",
                  section: "76",
                  penalty:
                      "Imprisonment for life or imprisonment up to 10 years, as the case may be",
                ),
                PenaltieCard(
                  title:
                      "Endangering safety of persons traveling by Metro railway by rash or negligent act or omission",
                  section: "77",
                ...
                PenaltieCard(
                  title:
                      "Endangering safety of persons traveling by Metro railway by willful act or omission",
                  section: "79",
